...
#continuing even after getting a value
languages=["c++", "Java", "Python", "Javascript", "Java"]
print("What language are you looking for?")
lang=input()
for language in languages:
    if language==lang:
        print("We found "+lang)
        continue
    print(language + " ...is not what we are looking for.")
    #continue looks for other instances of the same value being looked for