...
#This will break if one element is not in a list. 
...
print_2d(["chickity", "china", "chinese", "chicken", 
[1, 3, 3], [4]])
...
#We can also sort using a different function to determine 
# which comes first:

print(sorted(data, key=sum))

#You can also reverse the order:
print(sorted(data, key=sum, reverse=True)) #each list stays same, 
#just order of list is flipped


########## CUSTOM KEY FUNCTION ##########


#Any fuction you could use on a list to manipulate the data 
# should do the trick
...
data = [[5, 5, 5], [3, 4, 5], [3, -3, 0], [1,1,1,79], 
[1, 10, 1, 20]]
