...
#Obviously on our health adventures we want to know if something
#  is healthy.
...
print(id(backpack))#initial location
backpack[:] = [item for item in backpack if item in healthy]
#[:] keeps same object id
print(backpack)
print(id(backpack))#location is not changed after operation


print(id(backpack))#initial location
backpack = [item for item in backpack if item in healthy]
print(backpack)
print(id(backpack))#location changed after operation

#similar to this (except this one creates new variable healthy_backup):
healthy_backpack = []
for item in backpack:
    if item in healthy:
        healthy_backpack.append(item.upper())#adds to list in uppercase
...
print("The squares of ", i, i+2,i+4,i+6,i+8 ,"with a remainder of 0 = ", squares)
...
#You may think of something like healthy.size() or healthy.length()
#  or even healthy.count()
...
backpack2 = {"sword", "rubber duck", "slice a pizza", 
"parachute", "sword"}
...
backpack = ["sword", "rubber duck", "slice of pizza", 
"parachute",
