...
print(sorted(letters, key=str.lower),end='\n\n')
...
print(sorted(random, key=len),end='\n\n')
...
print(sorted(numbers, key=str),end='\n\n')
...
#Just like we compared using strings in the previous section, 
...
age = 5
stuff = [True, False, 0, -1, "0", "1", "10", age < 30, 
"20", "2", "5", "9001", "5.5", "6.0", 6]
