...
#We use the module with dot notation to access the functions 
# or variables
...
print("Today we are going to plant", seed, "seeds! Yay!") 
#Not what we wanted. 

#We can get a better picture of this by printing the output 
# of dir()
...
#You can see the places modules are searched for by importing 
# a special module
